...
class SaveAdapter(private val JobList : List<JobList>,
...
//        val btnSave: ImageButton =view.findViewById(R.id.saveBut)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.save_view, parent, false)
...
//                    val a =i.child("bookmarkId").value.toString()
//                    b =Integer.valueOf(a)
//
//                }
//                    val jobSave = Bookmark((b+1).toString(),"23",selectJob.id.toString())
